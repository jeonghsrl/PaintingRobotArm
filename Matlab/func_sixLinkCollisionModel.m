...
tform = tform*axang2tform([0 1 0 pi/2]);        %移動後、Z軸回りpi/2回転。
...
tform = tform*axang2tform([0 1 0 -pi/2]);       %その後、X軸回り-pi/2回転 
...
tform = trvec2tform([L5, 0, 0]);               %joint5から-Y方向へL5移動 
tform = tform*axang2tform([0 1 0 pi/2]);        %その後、X軸回りpi/2回転
...
addVisual(robot.Bodies{1},"Mesh",'./armSTL_1211/base.stl',tform);
tform = trvec2tform([0,0,L1]); 
addVisual(robot.Bodies{1},"Mesh",'./armSTL_1211/link1.stl',tform);
tform = trvec2tform([0,0,0]); 
addVisual(robot.Bodies{2},"Mesh",'./armSTL_1211/link2.stl',tform);
tform = trvec2tform([0,0,0]); 
addVisual(robot.Bodies{3},"Mesh",'./armSTL_1211/link3.stl',tform);
tform = trvec2tform([0,0,0]); 
addVisual(robot.Bodies{4},"Mesh",'./armSTL_1211/link4.stl',tform);
tform = trvec2tform([0,0,0]); 
addVisual(robot.Bodies{5},"Mesh",'./armSTL_1211/link5.stl',tform);
tform = trvec2tform([0,0,0]); 
addVisual(robot.Bodies{6},"Mesh",'./armSTL_1211/link6.stl',tform);
tform = trvec2tform([0,0,-0.06]); 
addVisual(robot.Bodies{7},"Mesh",'./armSTL_1211/tool.stl',tform);
